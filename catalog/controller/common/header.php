...
$data['mega_menu_products'] = [];

foreach ($results as $product) {
    $image = $product['image']
        ? $this->model_tool_image->resize($product['image'], 150, 150)
        : $this->model_tool_image->resize('placeholder.png', 150, 150);
    ...
    $data['mega_menu_products'][] = [
		...
		$data['custom_css'] = 'catalog/view/stylesheet/custom.css';
		...
		// header controls
		$data['header_controls'] = $this->load->controller('common/header_controls');
		$data['side_menu'] = $this->load->controller('common/side_menu');
