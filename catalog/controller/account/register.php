	...
	public function index(): void {
		if ($this->customer->isLogged()) {
			$this->response->redirect($this->url->link('account/account', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'], true));
		        ...
		        // **REDIRECT TO MOBILE VERIFICATION - DISABLE LEGACY REGISTER**
        $this->response->redirect($this->url->link('account/mobile_verify', 'language=' . $this->config->get('config_language')));
        return;
