...
foreach ($custom_fields as $custom_field) {
    if ($custom_field['status']) {
        ...
        // get saved value for this customer, default to empty string
        $saved_value = '';
        if (!empty($customer_info['custom_field'][$custom_field_id])) {
            $saved_value = $customer_info['custom_field'][$custom_field_id];
            // if it's still an array, convert to string
            if (is_array($saved_value)) {
                $saved_value = implode(', ', $saved_value);
            }
        }
