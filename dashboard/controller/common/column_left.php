...
class ColumnLeft extends \Opencart\System\Engine\Controller {
    ...
    'icon'     => 'fa-users',
    'name'     => 'Referrals',
    'href'     => $this->url->link('marketing/referral', 'user_token=' . $this->session->data['user_token']),
    'children' => []
];
$data['menus'][] = [
    'id'       => 'menu-referral',
    'icon'     => 'fa-users',
    'name'     => 'Contact Form',
    'href'     => $this->url->link('marketing/contact_form', 'user_token=' . $this->session->data['user_token']),
    'children' => []
];
$data['menus'][] = [
    'id'       => 'menu-sms-logs',
    'icon'     => 'fa-envelope',
    'name'     => 'SMS Logs',   
    'href'     => $this->url->link('marketing/sms_logs', 'user_token=' . $this->session->data['user_token'], true),
    'children' => []
];
